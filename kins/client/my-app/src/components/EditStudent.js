...
export default function EditStudent() {
    ...
    useEffect(() => {
        const fetchStudent = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/students/${id}`); // Ensure this URL is correct
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`${process.env.REACT_APP_BACKEND_URL}/api/students/${id}`, student); // Ensure this URL is correct
